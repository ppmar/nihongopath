...
export default function N4VocabularyPage() {
  ...
  const questions = useMemo(
    () => generateVocabQuestions(vocabData, "n4", quizMode, 10),
    [quizMode, quizKey]
  );
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Vocabulaire N4 <span className="text-muted-foreground font-normal text-lg">語彙</span></h1>
