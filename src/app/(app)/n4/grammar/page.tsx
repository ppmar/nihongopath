...
export default function N4GrammarPage() {
  ...
  const questions = useMemo(
    () => generateGrammarQuestions(grammarData, "n4", quizMode, 10),
    [quizMode, quizKey]
  );
  ...
  if (mode === "quiz") {
    return (
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <QuizEngine key={quizKey} questions={questions} title="Quiz Grammaire N4" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Grammaire N4 <span className="text-muted-foreground font-normal text-lg">文法</span></h1>
