...
export default function N3KanjiPage() {
  ...
  const questions = useMemo(
    () => generateKanjiQuestions(kanjiData, "n3", quizMode, 10),
    [quizMode, quizKey]
  );
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Kanji N3 <span className="text-muted-foreground font-normal text-lg">漢字</span></h1>
