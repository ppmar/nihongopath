...
const level = JLPT_LEVELS.n3;

const SECTIONS = [
  { href: "/n3/kanji", title: "Kanji", titleJp: "漢字", description: `${level.kanjiCount} kanji de niveau N3.`, count: `${level.kanjiCount} kanji`, icon: Languages, color: "text-violet-400", bgColor: "bg-violet-500/10" },
  { href: "/n3/vocabulary", title: "Vocabulaire", titleJp: "語彙", description: `Vocabulaire courant pour le N3.`, count: `${level.vocabCount} mots`, icon: BookOpen, color: "text-blue-400", bgColor: "bg-blue-500/10" },
  { href: "/n3/grammar", title: "Grammaire", titleJp: "文法", description: `Structures grammaticales N3.`, count: `${level.grammarCount} points`, icon: PenTool, color: "text-emerald-400", bgColor: "bg-emerald-500/10" },
  { href: "/n3/practice", title: "Pratique", titleJp: "練習", description: "Quiz et exercices N3.", count: "Quiz", icon: GraduationCap, color: "text-amber-400", bgColor: "bg-amber-500/10" },
];
