...
function generateQuestions(quizType: QuizType): QuizQuestion[] {
  switch (quizType) {
    case "kanji-meaning": return generateKanjiQuestions(kanjiData, "n2", "kanji-meaning", 10);
    case "kanji-reading": return generateKanjiQuestions(kanjiData, "n2", "kanji-reading", 10);
    case "meaning-kanji": return generateKanjiQuestions(kanjiData, "n2", "meaning-kanji", 10);
    case "vocab-meaning": return generateVocabQuestions(vocabData, "n2", "word-meaning", 10);
    case "meaning-vocab": return generateVocabQuestions(vocabData, "n2", "meaning-word", 10);
    case "vocab-reading": return generateVocabQuestions(vocabData, "n2", "word-reading", 10);
    case "grammar-meaning": return generateGrammarQuestions(grammarData, "n2", "pattern-meaning", 10);
    case "meaning-grammar": return generateGrammarQuestions(grammarData, "n2", "meaning-pattern", 10);
    default: return [];
  }
}
  ...
  if (quizType && questions.length > 0) {
    ...
    return (
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <QuizEngine key={quizKey} questions={questions} title={`Quiz N2 · ${qt?.title ?? ""}`} onComplete={handleComplete} />
      </div>
    );
  }
