...
export default function N1KanjiPage() {
  ...
  const questions = useMemo(
    () => generateKanjiQuestions(kanjiData, "n1", quizMode, 10),
    [quizMode, quizKey]
  );
  ...
  if (mode === "quiz") {
    return (
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <QuizEngine key={quizKey} questions={questions} title="Quiz Kanji N1" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Kanji N1 <span className="text-muted-foreground font-normal text-lg">漢字</span></h1>
