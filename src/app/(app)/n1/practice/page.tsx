...
export default function N1PracticePage() {
  ...
  if (quizType && questions.length > 0) {
    ...
    return (
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <QuizEngine key={quizKey} questions={questions} title={`Quiz N1 · ${qt?.title ?? ""}`} onComplete={() => setQuizKey((k) => k + 1)} />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Pratique N1 <span className="text-muted-foreground font-normal text-lg">練習</span></h1>
