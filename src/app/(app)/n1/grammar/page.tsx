...
export default function N1GrammarPage() {
  ...
  const questions = useMemo(
    () => generateGrammarQuestions(grammarData, "n1", quizMode, 10),
    [quizMode, quizKey]
  );
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Grammaire N1 <span className="text-muted-foreground font-normal text-lg">文法</span></h1>
